...
configurable_parameters = [{'name': 'camera_name',                  'default': 'camera2', 'description': 'camera unique name'},
                           {'name': 'camera_namespace',             'default': os.getenv('ROS_NAMESPACE'), 'description': 'namespace for camera'},
                           {'name': 'serial_no',                    'default': "'235422300934'", 'description': 'choose device by serial number'},
                           ...
                           {'name': 'rgb_camera.profile',           'default': '848,480,0', 'description': 'color image width'},
                           ...
                           {'name': 'depth_module.profile',         'default': '848,480,0', 'description': 'depth module profile'},
