...
#include "tetra_msgs/msg/zone2.hpp"
...
class VirtualLayer2 : public nav2_costmap_2d::CostmapLayer {
public:
...
protected:
    ...
    void zoneCallback(const tetra_msgs::msg::Zone2::SharedPtr msg);

    /// \brief obstacle callback function
    void obstaclesCallback(const tetra_msgs::msg::Obstacles2::SharedPtr obstacles_msg);
    ...
    rclcpp::Subscription<tetra_msgs::msg::Obstacles2>::SharedPtr obstacles_sub_;
    rclcpp::Subscription<tetra_msgs::msg::Zone2>::SharedPtr zone_sub_;
