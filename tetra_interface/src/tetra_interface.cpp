...
//Custom Message//
#include "tetra_msgs/msg/gpio.hpp"
// //Custom Service//
#include "tetra_msgs/srv/led_control.hpp"
#include "tetra_msgs/srv/led_toggle_control.hpp"
#include "tetra_msgs/srv/toggle_on.hpp"
#include "tetra_msgs/srv/integrallog.hpp"
#include "tetra_msgs/srv/power_set_outport.hpp" 
#include "tetra_msgs/srv/power_get_io_status.hpp"
#include "tetra_msgs/srv/power_set_enable.hpp"
#include "tetra_msgs/srv/power_set_single_outport.hpp"
#include "tetra_msgs/srv/power_set_single_enable.hpp"
#include "tetra_msgs/srv/power_wheel_enable.hpp"
#include "tetra_msgs/srv/power_parameter_read.hpp"
#include "tetra_msgs/srv/power_parameter_write.hpp"
#include "tetra_msgs/srv/power_data_read.hpp"
#include "tetra_msgs/srv/power_adc_read.hpp"
#include "tetra_msgs/srv/power_version_read.hpp"
#include "tetra_msgs/srv/power_sonar_read.hpp" //Ultrasonic option//
#include "tetra_msgs/srv/power_sonar_cmd.hpp"  //Ultrasonic option//
#include "tetra_msgs/srv/conveyor_parameter_read.hpp"  //Conveyor option//
#include "tetra_msgs/srv/conveyor_auto_movement.hpp"   //Conveyor option//
#include "tetra_msgs/srv/conveyor_manual_movement.hpp" //Conveyor option//
#include "tetra_msgs/srv/conveyor_parameter_write.hpp" //Conveyor option//
#include "tetra_msgs/srv/conveyor_data_read.hpp"	   //Conveyor option//
...
public:
	...
	{
		//Publish list////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
		power_status_publisher = this->create_publisher<std_msgs::msg::Int32>("power_status", rclcpp::SystemDefaultsQoS());
		servo_publisher = this->create_publisher<std_msgs::msg::Int32>("servo_on", rclcpp::SystemDefaultsQoS());
		tetra_battery_publisher = this->create_publisher<std_msgs::msg::Int32>("tetra_battery", rclcpp::SystemDefaultsQoS());
		battery_voltage_publisher = this->create_publisher<std_msgs::msg::Float64>("battery_voltage", rclcpp::SystemDefaultsQoS());
		battery_current_publisher = this->create_publisher<std_msgs::msg::Float64>("battery_current", rclcpp::SystemDefaultsQoS());
		docking_status_publisher = this->create_publisher<std_msgs::msg::Int32>("docking_status", rclcpp::SystemDefaultsQoS());
		gpio_status_publisher = this->create_publisher<tetra_msgs::msg::Gpio>("gpio_status", rclcpp::SystemDefaultsQoS()); //tetra_msgs message_GPIO
		//Ultrasonic_Option//
		Ultrasonic1_publisher = this->create_publisher<sensor_msgs::msg::Range>("Ultrasonic_D_L", rclcpp::SensorDataQoS());
		Ultrasonic2_publisher = this->create_publisher<sensor_msgs::msg::Range>("Ultrasonic_R_L", rclcpp::SensorDataQoS());
		Ultrasonic3_publisher = this->create_publisher<sensor_msgs::msg::Range>("Ultrasonic_R_R", rclcpp::SensorDataQoS());
		Ultrasonic4_publisher = this->create_publisher<sensor_msgs::msg::Range>("Ultrasonic_D_R", rclcpp::SensorDataQoS());
		//Conveyor_Option//
		conveyor_sensor_publisher = this->create_publisher<std_msgs::msg::Int32>("conveyor_sensor", rclcpp::SystemDefaultsQoS());
		conveyor_movement_publisher = this->create_publisher<std_msgs::msg::Int32>("conveyor_movement", rclcpp::SystemDefaultsQoS());

		//Subscribe list//////////////////////////////////////////////////////////////////////////////////////////////////////////////////
		
		//Service list////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
		led_control_srv = create_service<tetra_msgs::srv::LedControl>(
        	"led_cmd", 
		std::bind(&TETRA_INTERFACE::LED_Control_Command, this, std::placeholders::_1, std::placeholders::_2));

		led_toggle_control_srv = create_service<tetra_msgs::srv::LedToggleControl>(
        	"led_toggle_cmd", 
		std::bind(&TETRA_INTERFACE::LED_Toggle_Command, this, std::placeholders::_1, std::placeholders::_2));

		toggle_on_srv = create_service<tetra_msgs::srv::ToggleOn>(
        	"turn_on_cmd", 
		std::bind(&TETRA_INTERFACE::Toggle_On_Command, this, std::placeholders::_1, std::placeholders::_2));

		integrallog_srv = create_service<tetra_msgs::srv::Integrallog>(
        	"log_cmd", 
		std::bind(&TETRA_INTERFACE::Integrallog_Command, this, std::placeholders::_1, std::placeholders::_2));

		power_set_outport_srv = create_service<tetra_msgs::srv::PowerSetOutport>(
        	"Power_outport_cmd", 
		std::bind(&TETRA_INTERFACE::Power_Set_Outport_Command, this, std::placeholders::_1, std::placeholders::_2));

		power_set_single_outport_srv = create_service<tetra_msgs::srv::PowerSetSingleOutport>(
		...
		power_get_io_status_srv = create_service<tetra_msgs::srv::PowerGetIoStatus>(
        	"Power_io_status_cmd", 
		std::bind(&TETRA_INTERFACE::Power_Get_IO_Status_Command, this, std::placeholders::_1, std::placeholders::_2));

		power_set_enable_srv = create_service<tetra_msgs::srv::PowerSetEnable>(
        	"Power_enable_cmd", 
		std::bind(&TETRA_INTERFACE::Power_Set_Enable_Command, this, std::placeholders::_1, std::placeholders::_2));

		power_set_single_enable_srv = create_service<tetra_msgs::srv::PowerSetSingleEnable>(
		...
		power_wheel_enable_srv = create_service<tetra_msgs::srv::PowerWheelEnable>(
        	"Power_wheel_enable_cmd", 
		std::bind(&TETRA_INTERFACE::Power_Wheel_Enable_Command, this, std::placeholders::_1, std::placeholders::_2));

		power_parameter_read_srv = create_service<tetra_msgs::srv::PowerParameterRead>(
		...
		power_parameter_write_srv = create_service<tetra_msgs::srv::PowerParameterWrite>(
		...
		conveyor_manual_movement_srv = create_service<tetra_msgs::srv::ConveyorManualMovement>(
		...
		conveyor_parameter_read_srv = create_service<tetra_msgs::srv::ConveyorParameterRead>(
		...
		conveyor_parameter_write_srv = create_service<tetra_msgs::srv::ConveyorParameterWrite>(
	...
	rclcpp::Publisher<tetra_msgs::msg::Gpio>::SharedPtr gpio_status_publisher; //tetra_msgs message_GPIO
...
private:
	////value/////////////////////////////////////////////////////////////////////////////////
	rclcpp::Service<tetra_msgs::srv::LedControl>::SharedPtr led_control_srv;
	rclcpp::Service<tetra_msgs::srv::LedToggleControl>::SharedPtr led_toggle_control_srv;
	rclcpp::Service<tetra_msgs::srv::ToggleOn>::SharedPtr toggle_on_srv;
	rclcpp::Service<tetra_msgs::srv::Integrallog>::SharedPtr integrallog_srv;
	rclcpp::Service<tetra_msgs::srv::PowerSetOutport>::SharedPtr power_set_outport_srv;
	rclcpp::Service<tetra_msgs::srv::PowerSetSingleOutport>::SharedPtr power_set_single_outport_srv;
	rclcpp::Service<tetra_msgs::srv::PowerGetIoStatus>::SharedPtr power_get_io_status_srv;
	rclcpp::Service<tetra_msgs::srv::PowerSetEnable>::SharedPtr power_set_enable_srv;
	rclcpp::Service<tetra_msgs::srv::PowerSetSingleEnable>::SharedPtr power_set_single_enable_srv;
	rclcpp::Service<tetra_msgs::srv::PowerWheelEnable>::SharedPtr power_wheel_enable_srv;
	rclcpp::Service<tetra_msgs::srv::PowerParameterRead>::SharedPtr power_parameter_read_srv;
	rclcpp::Service<tetra_msgs::srv::PowerParameterWrite>::SharedPtr power_parameter_write_srv;
	rclcpp::Service<tetra_msgs::srv::PowerDataRead>::SharedPtr power_data_read_srv;
	rclcpp::Service<tetra_msgs::srv::PowerAdcRead>::SharedPtr power_adc_read_srv;
	rclcpp::Service<tetra_msgs::srv::PowerVersionRead>::SharedPtr power_version_read_srv;
	rclcpp::Service<tetra_msgs::srv::ConveyorAutoMovement>::SharedPtr conveyor_auto_movement_srv;   //Conveyor option//
	rclcpp::Service<tetra_msgs::srv::ConveyorManualMovement>::SharedPtr conveyor_manual_movement_srv; //Conveyor option//
	rclcpp::Service<tetra_msgs::srv::ConveyorParameterRead>::SharedPtr conveyor_parameter_read_srv;  //Conveyor option//
	rclcpp::Service<tetra_msgs::srv::ConveyorParameterWrite>::SharedPtr conveyor_parameter_write_srv; //Conveyor option//
	rclcpp::Service<tetra_msgs::srv::ConveyorDataRead>::SharedPtr conveyor_data_read_srv; //Conveyor option//
	rclcpp::Service<tetra_msgs::srv::PowerSonarRead>::SharedPtr power_sonar_read_srv; //Ultrasonic option//
	rclcpp::Service<tetra_msgs::srv::PowerSonarCmd>::SharedPtr power_sonar_cmd_srv;  //Ultrasonic option//


	//Custom Service function command////////////////////////////////////////////////////////////////
	bool LED_Control_Command(
		const std::shared_ptr<tetra_msgs::srv::LedControl::Request> request, 
		const std::shared_ptr<tetra_msgs::srv::LedControl::Response> response)
	{
		bool bResult = false;
	...
	bool LED_Toggle_Command(
		const std::shared_ptr<tetra_msgs::srv::LedToggleControl::Request> request, 
		const std::shared_ptr<tetra_msgs::srv::LedToggleControl::Response> response)
	{
		bool bResult = false;
	...
	bool Toggle_On_Command(
		const std::shared_ptr<tetra_msgs::srv::ToggleOn::Request> request, 
		const std::shared_ptr<tetra_msgs::srv::ToggleOn::Response> response)
	{
		bool bResult = false;
	...
	bool Integrallog_Command(
		const std::shared_ptr<tetra_msgs::srv::Integrallog::Request> request, 
		const std::shared_ptr<tetra_msgs::srv::Integrallog::Response> response)
	{
		bool bResult = false;
	...
	bool Power_Set_Outport_Command(
		const std::shared_ptr<tetra_msgs::srv::PowerSetOutport::Request> request, 
		const std::shared_ptr<tetra_msgs::srv::PowerSetOutport::Response> response)
	{
		bool bResult = false;
	...
	bool Power_Set_Single_Outport_Command(
		const std::shared_ptr<tetra_msgs::srv::PowerSetSingleOutport::Request> request, 
		const std::shared_ptr<tetra_msgs::srv::PowerSetSingleOutport::Response> response)
	{
		bool bResult = false;
	...
	bool Power_Get_IO_Status_Command(
		const std::shared_ptr<tetra_msgs::srv::PowerGetIoStatus::Request> request, 
		const std::shared_ptr<tetra_msgs::srv::PowerGetIoStatus::Response> response)
	{
		bool bResult = false;
		//Input data
	...
	bool Power_Set_Enable_Command(
		const std::shared_ptr<tetra_msgs::srv::PowerSetEnable::Request> request, 
		const std::shared_ptr<tetra_msgs::srv::PowerSetEnable::Response> response)
	{
		bool bResult = false;
	...
	bool Power_Set_Single_Enable_Command(
		const std::shared_ptr<tetra_msgs::srv::PowerSetSingleEnable::Request> request, 
		const std::shared_ptr<tetra_msgs::srv::PowerSetSingleEnable::Response> response)
	{
		bool bResult = false;
	...
	bool Power_Wheel_Enable_Command(
		const std::shared_ptr<tetra_msgs::srv::PowerWheelEnable::Request> request, 
		const std::shared_ptr<tetra_msgs::srv::PowerWheelEnable::Response> response)
	{
		bool bResult = false;
	...
	bool Power_Paramter_Read_Command(
		const std::shared_ptr<tetra_msgs::srv::PowerParameterRead::Request> request, 
		const std::shared_ptr<tetra_msgs::srv::PowerParameterRead::Response> response)
	{
		bool bResult = false;
		...
		response->p8_battery_charging_offset = m_iParam8;
		...
		response->p14_led_ch1_offset = m_iParam14;
		response->p15_led_ch2_offset = m_iParam15;
		response->p16_led_ch3_offset = m_iParam16;
		response->p17_led_ch4_offset = m_iParam17;
		response->p18_led_ch5_offset = m_iParam18;
		response->p19_led_ch6_offset = m_iParam19;
		response->p20_led_ch7_offset = m_iParam20;
		response->p21_led_ch8_offset = m_iParam21;
	...
	bool Power_Paramter_Write_Command(
		const std::shared_ptr<tetra_msgs::srv::PowerParameterWrite::Request> request, 
		const std::shared_ptr<tetra_msgs::srv::PowerParameterWrite::Response> response)
	{
		bool bResult = false;
	...
	bool Power_Data_Read_Command(
		const std::shared_ptr<tetra_msgs::srv::PowerDataRead::Request> request, 
		const std::shared_ptr<tetra_msgs::srv::PowerDataRead::Response> response)
	{
		bool bResult = false;
		...
		response->d7_charger_terminal_status = m_iParam7;
	...
	bool Power_ADC_Read_Command(
		const std::shared_ptr<tetra_msgs::srv::PowerAdcRead::Request> request, 
		const std::shared_ptr<tetra_msgs::srv::PowerAdcRead::Response> response)
	{
		bool bResult = false;
	...
	bool Power_Version_Read_Command(
		const std::shared_ptr<tetra_msgs::srv::PowerVersionRead::Request> request, 
		const std::shared_ptr<tetra_msgs::srv::PowerVersionRead::Response> response)
	{
		bool bResult = false;
	...
	bool Conveyor_Auto_Movement_Command(
		const std::shared_ptr<tetra_msgs::srv::ConveyorAutoMovement::Request> request, 
		const std::shared_ptr<tetra_msgs::srv::ConveyorAutoMovement::Response> response)
	{
		bool bResult = false;
	...
	bool Conveyor_Manual_Movement_Command(
		const std::shared_ptr<tetra_msgs::srv::ConveyorManualMovement::Request> request, 
		const std::shared_ptr<tetra_msgs::srv::ConveyorManualMovement::Response> response)
	{
		bool bResult = false;
	...
	bool Conveyor_Parameter_Read_Command(
		const std::shared_ptr<tetra_msgs::srv::ConveyorParameterRead::Request> request, 
		const std::shared_ptr<tetra_msgs::srv::ConveyorParameterRead::Response> response)
	{
		bool bResult = false;
		...
		response->p4_loadcell_zero = m_iParam4;
		response->p5_loadcell_min = m_iParam5;
		response->p6_loadcell_gain = m_iParam6;
		...
		response->p19_terminal_loading_base = m_iParam19;
		response->p20_terminal_unloading_base = m_iParam20;
	...
	bool Conveyor_Parameter_Write_Command(
		const std::shared_ptr<tetra_msgs::srv::ConveyorParameterWrite::Request> request, 
		const std::shared_ptr<tetra_msgs::srv::ConveyorParameterWrite::Response> response)
	{
		bool bResult = false;
		dssp_rs232_conveyor_module_parameter_write(request->num, request->data);
	...
	bool Conveyor_Data_Read_Command(
		const std::shared_ptr<tetra_msgs::srv::ConveyorDataRead::Request> request, 
		const std::shared_ptr<tetra_msgs::srv::ConveyorDataRead::Response> response)
	{
		bool bResult = false;
		...
		response->d5_loadcell_low = m_iParam5;
		response->d6_loadcell_sen = m_iParam6;
	...
	bool Power_Sonar_Read_Command(
		const std::shared_ptr<tetra_msgs::srv::PowerSonarRead::Request> request, 
		const std::shared_ptr<tetra_msgs::srv::PowerSonarRead::Response> response)
	{
		bool bResult = false;
	...
	bool Power_Sonar_Command(
		const std::shared_ptr<tetra_msgs::srv::PowerSonarCmd::Request> request, 
		const std::shared_ptr<tetra_msgs::srv::PowerSonarCmd::Response> response)
	{
		bool bResult = false;
...
int main(int argc, char * argv[])
{
	...
	TETRA_INTERFACE tetra_interface;
	...
	while (rclcpp::ok())
	{
		...
		if(m_iPowerCheck < 0)
		{
			...
			if(m_iFlag_PowerCheck_cnt > 10)
			{
				...
				servo.data = 2;
				tetra_interface.servo_publisher->publish(servo);
			}
			else
			{
		...
		tetra_interface.gpio_status_publisher->publish(gpio_msg);
		...
		range_msg1.header.stamp = tetra_interface.current_time ;
		...
		range_msg2.header.stamp = tetra_interface.current_time ;
		...
		range_msg3.header.stamp = tetra_interface.current_time ;
		...
		if(m_bUltrasonic_option) //Option --> default: false
		{
			...
			tetra_interface.Ultrasonic3_publisher->publish(range_msg3);
			tetra_interface.Ultrasonic4_publisher->publish(range_msg4);
		}
		///////////////////////////////////////////////////////////////////////////////////////
		...
		if(m_bConveyor_option)
		{
			...
			tetra_interface.conveyor_sensor_publisher->publish(conveyor_sensor);
			...
			tetra_interface.conveyor_movement_publisher->publish(conveyor_movement);
		}
		///////////////////////////////////////////////////////////////////////////////////////
