...
#include "tetra_msgs/srv/docking_control.hpp" //docking
#include "tetra_msgs/srv/docking_stop.hpp" //docking
...
public:
	TETRA_SERVICE() : Node("tetra_service")
	{
		...
		//publish list/////////////////////////////////////////////////////////////////////////////////////
		cmd_vel_publisher = this->create_publisher<geometry_msgs::msg::Twist>("cmd_vel", rclcpp::SensorDataQoS());
		...
		bumper_subscriber = this->create_subscription<std_msgs::msg::Int32>(
			"bumper_data", rclcpp::SystemDefaultsQoS(), std::bind(&TETRA_SERVICE::BumperCallback, this, _1));

		emg_subscriber = this->create_subscription<std_msgs::msg::Int32>(
			"emg_state", rclcpp::SystemDefaultsQoS(), std::bind(&TETRA_SERVICE::EMGCallback, this, _1));

		tetra_battery_subscriber = this->create_subscription<std_msgs::msg::Int32>(
			"tetra_battery", rclcpp::SystemDefaultsQoS(), std::bind(&TETRA_SERVICE::BatteryCallback, this, _1));
		
		docking_status_subscriber = this->create_subscription<std_msgs::msg::Int32>(
			"docking_status", rclcpp::SystemDefaultsQoS(), std::bind(&TETRA_SERVICE::DockingStatusCallback, this, _1));
		
		conveyor_sensor_subscriber = this->create_subscription<std_msgs::msg::Int32>(
			"conveyor_sensor", rclcpp::SystemDefaultsQoS(), std::bind(&TETRA_SERVICE::ConveyorSensorCallback, this, _1));

		conveyor_movement_subscriber = this->create_subscription<std_msgs::msg::Int32>(
			"conveyor_movement", rclcpp::SystemDefaultsQoS(), std::bind(&TETRA_SERVICE::ConveyorMovementCallback, this, _1));
		...
		//Service list///////////////////////////////////////////////////////////////////////////////////////
		docking_cmd_srv = create_service<tetra_msgs::srv::DockingControl>(
      "docking_cmd", 
		std::bind(&TETRA_SERVICE::Docking_Command, this, std::placeholders::_1, std::placeholders::_2));

		docking_stop_cmd_srv = create_service<tetra_msgs::srv::DockingStop>(
      "docking_stop_cmd", 
		std::bind(&TETRA_SERVICE::Docking_Stop_Command, this, std::placeholders::_1, std::placeholders::_2));

		save_map_cmd_srv = create_service<tetra_msgs::srv::SaveMap>(
      "save_map_cmd", 
		std::bind(&TETRA_SERVICE::Save_Map_Command, this, std::placeholders::_1, std::placeholders::_2));


		//Client list///////////////////////////////////////////////////////////////////////////////////////
		led_control_client = this->create_client<tetra_msgs::srv::LedControl>("led_cmd");
		led_toggle_control_client = this->create_client<tetra_msgs::srv::LedToggleControl>("led_toggle_cmd");
		toggle_on_client = this->create_client<tetra_msgs::srv::ToggleOn>("turn_on_cmd");
		imu_reset_client = this->create_client<tetra_msgs::srv::ImuReset>("all_data_reset");
	...
	void LedControl_callback(rclcpp::Client<tetra_msgs::srv::LedControl>::SharedFuture future)
	{
		//RCLCPP_INFO(this->get_logger(), "response LedControl_callback");

	}
	void LedToggleControl_callback(rclcpp::Client<tetra_msgs::srv::LedToggleControl>::SharedFuture future)
	{
		//RCLCPP_INFO(this->get_logger(), "response LedToggleControl_callback");

	}
	void ToggleOn_callback(rclcpp::Client<tetra_msgs::srv::ToggleOn>::SharedFuture future)
	{
		//RCLCPP_INFO(this->get_logger(), "response ToggleOn_callback");
	}
	
	void ImuReset_callback(rclcpp::Client<tetra_msgs::srv::ImuReset>::SharedFuture future)
	{
	...
	{
		bool bResult = false;
		if(_pAR_tag_pose.m_transform_pose_x <= 0.65 && _pAR_tag_pose.m_iAR_tag_id != -1) //650mm depart move
		{
	...
	bool Docking_Command(
		const std::shared_ptr<tetra_msgs::srv::DockingControl::Request> request, 
		const std::shared_ptr<tetra_msgs::srv::DockingControl::Response> response)
	{
		bool bResult = false;
	...
	bool Docking_Stop_Command(
		const std::shared_ptr<tetra_msgs::srv::DockingStop::Request> request, 
		const std::shared_ptr<tetra_msgs::srv::DockingStop::Response> response)
	{
		bool bResult = false;
	...
	bool Save_Map_Command(
		const std::shared_ptr<tetra_msgs::srv::SaveMap::Request> request, 
		const std::shared_ptr<tetra_msgs::srv::SaveMap::Response> response)
	{
		bool bResult = false;
    ...
    {
        auto request = std::make_shared<tetra_msgs::srv::LedControl::Request>();
        request->id = id;
    ...
    {
        auto request = std::make_shared<tetra_msgs::srv::LedToggleControl::Request>();
    ...
    {
        auto request = std::make_shared<tetra_msgs::srv::ToggleOn::Request>();
        request->id = id;
	...
	void ImuReset_Call() 
    {
        auto request = std::make_shared<tetra_msgs::srv::ImuReset::Request>();
...
private:
	...
	rclcpp::Client<tetra_msgs::srv::ToggleOn>::SharedPtr toggle_on_client;
	rclcpp::Client<tetra_msgs::srv::ImuReset>::SharedPtr imu_reset_client;
	rclcpp::Client<std_srvs::srv::Empty>::SharedPtr request_nomotion_update_client;
	rclcpp::Client<nav2_msgs::srv::ClearEntireCostmap>::SharedPtr clear_entire_costmap_client;
...
int main(int argc, char * argv[])
{
	...
	while (rclcpp::ok())
	{
		...
		if(m_iPose_reset_cnt > 500 && m_bActive_map)
		{
			tetra_service.Reset_Robot_Pose();
			tetra_service.Clear_Costmap();
			m_iPose_reset_cnt = 0;
		}
		else
		{
