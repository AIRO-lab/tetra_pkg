...
rclcpp::Client<tetra_msgs::srv::GotoCancel>::SharedPtr goto_cancel_cmd_client;
auto goto_cancel_cmd_service = std::make_shared<tetra_msgs::srv::GotoCancel::Request>();
rclcpp::Client<tetra_msgs::srv::SetLocation>::SharedPtr set_location_cmd_client;
auto set_location_cmd_service = std::make_shared<tetra_msgs::srv::SetLocation::Request>();
rclcpp::Client<tetra_msgs::srv::GetLocation>::SharedPtr get_location_cmd_client;
auto get_location_cmd_service = std::make_shared<tetra_msgs::srv::GetLocation::Request>();
...
rclcpp::Client<tetra_msgs::srv::SaveMap>::SharedPtr mapsave_cmd_client;
auto mapsave_cmd_service = std::make_shared<tetra_msgs::srv::SaveMap::Request>();
...
rclcpp::Client<tetra_msgs::srv::DeleteLocation>::SharedPtr delete_location_cmd_client;
auto delete_location_cmd_service = std::make_shared<tetra_msgs::srv::DeleteLocation::Request>();
rclcpp::Client<tetra_msgs::srv::DockingControl>::SharedPtr docking_control_cmd_client;
auto docking_control_cmd_service = std::make_shared<tetra_msgs::srv::DockingControl::Request>();
...
int main(int argc, char* argv[])
{
  ...
  goto_cancel_cmd_client = nodes->create_client<tetra_msgs::srv::GotoCancel>("goto_cancel_cmd");
  get_location_cmd_client = nodes->create_client<tetra_msgs::srv::GetLocation>("get_location_cmd");
  ...
  set_location_cmd_client = nodes->create_client<tetra_msgs::srv::SetLocation>("set_location_cmd");
  ...
  mapsave_cmd_client = nodes->create_client<tetra_msgs::srv::SaveMap>("savemap_cmd");
  nodekill_cmd_client = nodes->create_client<tetra_msgs::srv::RosNodeKill>("nodekill_cmd");
  delete_location_cmd_client = nodes->create_client<tetra_msgs::srv::DeleteLocation>("delete_location_cmd");
  docking_control_cmd_client = nodes->create_client<tetra_msgs::srv::DockingControl>("docking_cmd");
